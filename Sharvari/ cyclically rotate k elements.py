...
\f0\fs26 \cf2 \cb3 #To rotate 'k'elements of the array to the left.\
...
\cf4 n=\cf7 len\cf4 (x);\
\
\cf6 for \cf4 i \cf6 in \cf7 range\cf4 (k):\
    temp=x[\cf5 0\cf4 ];\
\
    \cf6 for \cf4 i \cf6 in \cf7 range\cf4 (\cf5 0\cf6 ,\cf4 n-\cf5 1\cf4 ):\
        x[i]=x[i+\cf5 1\cf4 ];\
\
    x[n-\cf5 1\cf4 ]=temp;\
\cf7 print\cf4 (x)\
